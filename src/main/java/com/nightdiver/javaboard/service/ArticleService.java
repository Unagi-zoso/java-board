...
import com.nightdiver.javaboard.dto.ArticleDto;
...
public class ArticleService {
    ...
    public ArticleWithCommentsDto getArticle(Long articleId) {
        return articleRepository.findById(articleId)
                ...
                .orElseThrow(() -> new EntityNotFoundException("게시글이 없습니다 - articleId: " + articleId)); // 운영엔 편해도 정보가 노출되어 보안 중요성을 고려하자
    }
    ...
    public void updateArticle(ArticleDto dto) {
        try {
            ...
            log.warn("게시글을 찾을 수 없습니다. - articleId: {}", dto.id());
        }
